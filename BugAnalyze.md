...
- Write detailed content based on the Bug/RCA
- Content should be ready to insert into identified sections
- Use language appropriate for a user guide
- Focus on technical solution, not analysis process
- Include:
  * Problem description (brief)
  * Configuration steps or behavior explanation
  * Any caveats or limitations
  * Related commands or features (if applicable)
